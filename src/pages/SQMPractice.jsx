...
import practiceData from '../data/sqm_qa.json';

export default function SQMPractice({ onBack }) {
    ...
    <div className="max-w-4xl mx-auto w-full px-4 h-[calc(100vh-120px)] flex flex-col justify-center animate-in fade-in duration-500">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#6366f1] text-white flex items-center justify-center font-bold shadow-md">S</div>
          <h2 className="text-xl md:text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">SQM Practice</h2>
        </div>
