...
// (Make sure to run this file with: node --env-file=.env seedErpData.js)
...
async function seedData() {
  const subject = "ERP"; // Matching the dropdown name in Admin panel
  let insertedCount = 0;
  let errorsCount = 0;
  ...
  for (const [category, questionsList] of Object.entries(erp)) {
